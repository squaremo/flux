...
func (i *instrumentedDB) LogEvent(inst service.InstanceID, e history.Event) (err error) {
...
func (i *instrumentedDB) AllEvents(inst service.InstanceID, before time.Time, limit int64) (e []history.Event, err error) {
	defer func(begin time.Time) {
		requestDuration.With(
...
func (i *instrumentedDB) EventsForService(inst service.InstanceID, s flux.ServiceID, before time.Time, limit int64) (e []history.Event, err error) {
	defer func(begin time.Time) {
		requestDuration.With(
...
func (i *instrumentedDB) GetEvent(id history.EventID) (e history.Event, err error) {
	defer func(begin time.Time) {
		requestDuration.With(
